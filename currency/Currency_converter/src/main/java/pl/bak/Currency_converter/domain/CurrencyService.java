...
import pl.bak.Currency_converter.domain.dao.CurrencyRepository;
...
public class CurrencyService {
    ...
    public CurrencyService(ValueCalculate valueCalculate, BodyFromApi bodyFromApi, CurrencyRepository currencyRepository) {
        this.valueCalculate = valueCalculate;
        this.bodyFromApi = bodyFromApi;
        this.currencyRepository = currencyRepository;
    }

    public Set<DataInMultiArray> getAll () {
        return bodyFromApi.getAllBodyFromApi();
    }
